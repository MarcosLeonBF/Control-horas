...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: 'node-horas',
      testMatch: ['**/horas-alertas.spec.ts', '**/horas-carry.spec.ts', '**/horas-reportes-mes.spec.ts', '**/horas-auditoria-diff.spec.ts', '**/horas-registro-minutos.spec.ts'],
    },
