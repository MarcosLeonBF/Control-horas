-- 0030_horas_registro_14_dias.sql
-- Temporal: amplía la ventana de registro de 7 a 14 días atrás para que los
-- usuarios puedan cargar registros viejos. Se volverá a 7 en el futuro.
--
-- Único cambio respecto a 0028: current_date - 7 → current_date - 14 y el
