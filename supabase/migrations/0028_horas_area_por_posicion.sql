-- 0028_horas_area_por_posicion.sql
-- El área al registrar sale de la POSICIÓN del usuario, no de user_areas.
--
-- Decisión (2026-07-03): la posición define las áreas a las que se pertenece; el área de
-- cada línea de proyecto cliente debe estar entre las áreas de la posición del dueño, para
-- TODOS los roles. user_areas deja de gobernar el registro (pasa a ser solo la visibilidad
-- del manager: qué áreas ve su equipo/reportes, migración 0018).
--
-- Único cambio respecto a 0027: la validación de área en proyecto cliente usa position_areas
-- en vez de user_areas. Descripción/etapa/departamento sin cambios.
